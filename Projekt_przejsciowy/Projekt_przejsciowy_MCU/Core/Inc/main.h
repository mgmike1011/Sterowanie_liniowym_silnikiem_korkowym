...
#define END_STOP_2_Pin GPIO_PIN_9
#define END_STOP_2_GPIO_Port GPIOE
#define END_STOP_2_EXTI_IRQn EXTI9_5_IRQn
#define END_STOP_1_Pin GPIO_PIN_11
#define END_STOP_1_GPIO_Port GPIOE
#define END_STOP_1_EXTI_IRQn EXTI15_10_IRQn
